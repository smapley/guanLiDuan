...
import com.smapley.neibu.http.service.RegService;
import com.smapley.neibu.http.service.RegzhuceService;
...
public class Login extends Activity {
    ...
    public void checkLogin(View view) {
        ...
        if (log_st_usernmae != null && !log_st_usernmae.equals("")) {
            ...
            if (log_st_password != null && !log_st_password.equals("")) {
                reg1Service.load(new RegParams(log_st_usernmae, log_st_password));
            } else {
    ...
    private RegService reg1Service = new RegService() {
        @Override
